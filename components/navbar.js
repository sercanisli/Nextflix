...
const Navbar = () => {
  return (
    <nav className="bg-gray-700 text-center">
        <div className="grid justify-items-stretch font-bold text-neutral-100 p-4 max-w-7xl mx-auto container tracking-widest ">
            ...
            <Link href="/category" legacyBehavior className="font-bold text-neutral-100 p-4 max-w-7xl mx-auto container tracking-widest">
                <a className="text-base md:text-2xl justify-self-center">Categories</a>
            </Link>
        </div>
