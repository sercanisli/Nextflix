...
const Movie = ({movie}) => {
    console.log(movie);
  return (
    <div className="container max-w-4xl mx-auto pt-6 flex items-center">
        <div className="px-3 grid grid-cols-2 py-24">
            <div className="">
                <Image src={`https://image.tmdb.org/t/p/w500/${movie.poster_path}`} width={250} height={180}/>
            </div>
            <div className="">
