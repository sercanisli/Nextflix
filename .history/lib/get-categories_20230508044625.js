...
function CategoryMovieList() {
  ...
  useEffect(() => {
    async function fetchData() {
      ...
      setSelectedCategory(categories.genres[null] || { genre_id: null, name: 'Popular' });
  ...
  useEffect(() => {
    async function fetchData() {
      ...
      if (selectedCategory.genre_id) {
        endpoint = `https://api.themoviedb.org/3/discover/movie?api_key=7727a1c97bc5205612f2769b66dcf4fe&with_genres=${selectedCategory.genre_id}`;
      } else {
        endpoint = 'https://api.themoviedb.org/3/movie/popular?api_key=7727a1c97bc5205612f2769b66dcf4fe';
      }
